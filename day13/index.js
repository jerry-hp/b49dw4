...
// connection to postgreesql with Sequelize
...
async function home(req, res) {
  try {
    const query = `SELECT id, title, start_date, end_date, description, image FROM public.db_projects;`;
    ...
    res.render("index", { projectData: data });
  } catch (error) {
    console.log(error);
  }
}
